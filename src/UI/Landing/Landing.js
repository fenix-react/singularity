    ...
    return (
      <div className={classes.page}>
        ...
        <div className={classes.lang}>
            ...
            <NavLink style={{marginLeft: '0.7vw'}} className={classes.link} to='/'>English</NavLink>
        ...
        <CButton size="sm" className="btn-facebook btn-brand mr-1 mb-1"><CIcon name="cib-facebook" /><span>Facebook</span></CButton>
                     ...
                     <div className={classes.contentCont}>
                         ...
                         <p className={classes.content}> Share Your Moments</p>
                     </div>
                     <div  className={classes.contentCont}>
                     <i className={`fa fa-search ${classes.icon}`}></i>
                         <p className={classes.content}> Explore The World</p>
                     </div>
                     <div  className={classes.contentCont}>
                         <i className={`fa fa-heart ${classes.icon}`}></i>
                         <p className={classes.content}> Pursue Your Intrests</p>
                     </div>
        ...
        <div className={classes.halfPage2}>
            ...
            {props.error ? <div className={classes.errorCont}><p className={classes.error}><i className='fa fa-exclamation-circle'></i> {errorMessage}</p></div> : null}
            {props.loading ? <Spinner></Spinner> :<form><div className={classes.form}>
              {redirecting}
              <div className={classes.userName}>
                <i className={`fa fa-user ${classes.formIcon}`}></i>
                <input onChange={(e)=>{setEmail(e.target.value)}} value={email} type='email' className={classes.input} onFocus={(e)=>e.target.placeholder=''} onBlur={(e)=>e.target.placeholder='Email Or Username'} placeholder='Email Or Username'></input>
              </div>
              <div className={classes.userName}>
                <i className={`fa fa-lock ${classes.formIcon}`}></i>
                <input onChange={(e)=>{setPassword(e.target.value)}} onFocus={(e)=>e.target.placeholder=''} onBlur={(e)=>e.target.placeholder='Password'} type='Password' className={classes.input} placeholder='Password'></input>
              </div>
              <Link className={classes.forgot} to='/forgorPassword'>Forgot Password?</Link>
              <button onClick={
                ()=>{
                  this.props.startAuth(this.state.email,this.state.password,'sign in');
              ...
              <div className={classes.register}>
                Don`t have an account? <Link to='/register' style={{color: '#2ab8bc'}}>Register</Link>
              </div>
            </div></form> }
        </div>
      </div>
